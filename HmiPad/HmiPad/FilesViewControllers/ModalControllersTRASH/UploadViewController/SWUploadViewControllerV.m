...
@interface SWUploadViewControllerV ()<AppsFileModelObserver>
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    [filesModel() getRemoteFileMDForFileWithUUID:documentMD.identifier forCategory:kFileCategoryRemoteSourceFile];
