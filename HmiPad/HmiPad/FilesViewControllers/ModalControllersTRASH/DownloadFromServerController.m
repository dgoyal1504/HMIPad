...
- (ManagedTextFieldCell*)downloadFileNameCell
{
    if ( downloadFileNameCell == nil )
    {
        ...
        [tmpObj=[downloadFileNameCell textField] setPlaceholder:@"MyProject.csv"];     //**
...
{
    if ( section == kDownloadFromServerSection ) return NSLocalizedString( @"Download File From Server", nil ) ; 
    return nil ;
}
