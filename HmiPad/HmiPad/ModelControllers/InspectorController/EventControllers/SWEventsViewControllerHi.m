...
{    
    if ( infoLabel )
    {
        NSUInteger alarmsCount = _eventCenter.events.count;
        NSUInteger activeCount = _eventCenter.numberOfActiveEvents;
        NSString *limitsText = [NSString stringWithFormat:@"%d / %d", activeCount, alarmsCount];
