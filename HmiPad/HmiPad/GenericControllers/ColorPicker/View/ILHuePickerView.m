...
- (void)drawRect:(CGRect)rect
{
    ...
    CGFloat step=0.166666666666667f;
    ...
    // Draw the indicator
    CGFloat pos=(pickerOrientation==ILHuePickerViewOrientationHorizontal) ? rect.size.width*hue : rect.size.height*hue;
    CGFloat indLength=(pickerOrientation==ILHuePickerViewOrientationHorizontal) ? rect.size.height/3 : rect.size.width/3;
...
- (void)handleTouches:(NSSet *)touches withEvent:(UIEvent *)event pickingFinished:(BOOL)flag
{
    ...
    CGFloat p=(pickerOrientation==ILHuePickerViewOrientationHorizontal) ? pos.x : pos.y;
    CGFloat b=(pickerOrientation==ILHuePickerViewOrientationHorizontal) ? self.frame.size.width : self.frame.size.height;
    ...
    [delegate huePicked:hue picker:self pickingFinished:flag];
